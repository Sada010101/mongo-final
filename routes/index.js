...
router.get("/toMongo", function (req, res) {
    ...
    async function run() {
        try {
            ...
            const info = { brand: req.query.brand, size: +req.query.size, color: req.query.color, date: req.query.date };
    ...
    res.render("clothes.hbs", {
        brand: req.query.brand, size: req.query.size, color: req.query.color, date: req.query.date,
    })
})
